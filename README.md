...
`docs/` 配下に、開発・運用・障害対応のためのドキュメントを整理しています。目的別に俯瞰したい場合は、まず [`docs/README.md`](docs/README.md)（`docs/` 目次）を参照してください。
...
- [`docs/METRICS.md`](docs/METRICS.md) — Pulse Monitor が扱うメトリクスの意味・SLI / SLO の目安
